<script>
  ...
  function productSearchEvt(search_value = "") {
    ...
    shownProducts = products.filter((e) => {
      return e.product_name.toLowerCase().includes(search_value.toLowerCase());
    });
  }
  ...
  function showOrder(showing = true) {
    showOrderMenu = showing;
  }
...
<div class="flex flex-col h-full">
  ...
  <div class="flex-col flex-1 overflow-hidden flex">
    ...
    {:else}
      ...
      {/if}
      <!-- <div class="flex-1 bg-red-400">hi</div> -->
    {/if}
  </div>
