...
<div class="h-full flex flex-col flex-1 pointer-none relative overflow-hidden">
  {#if mainMenuShowing}
    <div
      in:fly={{ y: -20 }}
      out:fly={{ x: 20 }}
      class="pt-5 bg-slate-200 flex absolute h-full w-full z-10"
    >
      <div
        ...
        <div class="flex w-[80%] gap-2 flex h-full flex-col pb-4 text-xl">
          ...
          >
            <div class="flex-1 flex justify-center items-center">
              ...
              <span class="ml-2 text-sm border-slate-500 border-l pl-2"
                >Ask for Assistance</span
              >
            </div>
          </div>
          <div class="w-full gap-2 flex h-full">
            ...
            >
              ...
              <span class="ml-2 border-l pl-2 text-sm border-slate-400"
                >Resume Order</span
              >
            </div>
          </div>
          ...
          >
            ...
            <span class="text-white text-sm pl-2 ml-2 border-l border-white"
              >Cancel Order</span
            >
          </div>
        </div>
