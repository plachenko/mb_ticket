...
<div class="h-full flex flex-col flex-1 pointer-none relative overflow-hidden">
  {#if mainMenuShowing}
    <div in:fly={{ y: 20 }} out:fly={{ x: 20 }} class="pt-5 bg-slate-200 flex absolute h-full w-full z-10">
      <div class="flex flex-1 items-center justify-center flex-col gap-6 landscape:p-4 landscape:flex-row">
        <img src="mbstacked.png" class="h-20" />

        <div class="flex w-[80%] gap-2 flex h-full flex-col pb-4 text-xl">
          <div class="h-20 rounded-md flex justify-center bg-slate-300 border border-slate-400 items-center">
            <div class="flex-1 flex justify-center items-center">
              ...
              <span class="ml-5">Ask for Assistance</span>
            </div>
          </div>
            <div class="w-full gap-2 flex h-full">
              <div class="rounded-md flex flex-1 bg-red-400 justify-center items-center h-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                </svg>
                <span>Edit Order</span>              
            </div>
              <div onclick={() => {mainMenuShowing = false}} class="rounded-md flex flex-1 bg-slate-300 border border-slate-400  justify-center items-center h-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mt-1 size-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                </svg>
                
                <span class="ml-5">Resume Order</span>

              </div>
          </div>
          <div class="h-20 rounded-md flex justify-center bg-red-400 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
